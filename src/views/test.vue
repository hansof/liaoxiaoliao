  ...
  <section class="container">
    ...
    <div class="bank_lists">
      <div class="bank_box">
        ...
        <div class="bank_list" v-for="item in bank_list" :key="item.id">
          <div class="bank_icon" :style="{ 'background-size': '100%' }" ></div>
          <span class="bank_name">{{item.bankName}}</span>
        </div>
      </div>
    </div>
    <div class="hot_box">
      ...
      <div class="hot_centenrt">
        <div class="hot_centent_left">
          ...
          <div class="hot_left_img" :style="{ 'background-size': '100%' }" ></div>
        </div>
        <div class="hot_centent_right">
          <div class="hot_right_top">
            ...
            <div class="hot_right_img" :style="{ 'background-size': '100%' }" ></div>
          </div>
    ...
    <div class="card_order">
      ...
      <li class="card_list" v-for="(item,index) in infiniteLoadData.pullUpList" :key="item.id">
        <div class="card_content" :class="infiniteLoadData.pullUpList.length - 1 != index? 'card_content_bottom':''">
          ...
          <div class="card_img" :style="{ 'background-size': '100%' }" ></div>
...
<script>
import DropDownRefresh from '../components/dropDownRefresh/dropDownRefresh'
import PullUpReload from '../components/pullUpReload/pullUpReload'
export default {
  data () {
    return {
      bank_list: [
